...
function buildMobileInvoiceHtml(order = {}) {
  ...
  <html>
    <head>
      ...
      <title>KOT</title>
      <style>
        body { font-family: Arial, sans-serif; font-size:12px; width:69mm; margin:0; padding:8px }
        ...
        .totalAmount { font-size:15px; font-weight:800; border:2px dashed; text-align:center; background:#000; color:#fff; padding:0.4rem }
    ...
    try {
      ...
      if (elementId) {
        ...
        const html = `<!doctype html><html><head><meta charset=\"utf-8\" /><title>KOT</title>
          <style>
            body { font-family: Arial, sans-serif; font-size: 12px; width: 69mm; }
            table { width: 100%; border-collapse: collapse; }
            th, td { border: 1px solid black; padding: 2px; text-align: left; font-size: 11px; color: #000 }
            .total { font-size: 13px; text-align: left; margin-top: 4px; display: flex; align-items: baseline; justify-content: space-between }
